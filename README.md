...
| `id` | bigint(20) UNSIGNED NOT NULL |  |
| `course_lesson_id` | bigint(20) UNSIGNED NOT NULL |  |
| `course_lesson_tag_id` | bigint(20) UNSIGNED NOT NULL |  |
| `created_at` | timestamp NULL DEFAULT NULL |  |
| `updated_at` | timestamp NULL DEFAULT NULL |  |
...
| --- | --- | --- |
| `id` | bigint(20) UNSIGNED NOT NULL |  |
| `hotline_id` | bigint(20) UNSIGNED NOT NULL |  |
| `user_id` | bigint(20) UNSIGNED DEFAULT NULL |  |
...
| --- | --- | --- |
| `id` | bigint(20) UNSIGNED NOT NULL |  |
| `quiz_activity_id` | bigint(20) UNSIGNED NOT NULL |  |
| `user_id` | bigint(20) UNSIGNED NOT NULL |  |
| `score` | int(11) NOT NULL DEFAULT '0' |  |
| `total_points` | int(11) NOT NULL DEFAULT '0' |  |
| `correct_count` | int(11) NOT NULL DEFAULT '0' |  |
| `total_questions` | int(11) NOT NULL DEFAULT '0' |  |
| `has_won_prize` | tinyint(1) NOT NULL DEFAULT '0' |  |
...
| `user_id` | bigint(20) UNSIGNED NOT NULL |  |
| `attempt_id` | bigint(20) UNSIGNED NOT NULL |  |
| `winner_name` | varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL |  |
